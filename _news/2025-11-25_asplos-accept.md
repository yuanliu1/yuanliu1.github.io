...
Our work on [COMPAS: A Distributed Multi-Party SWAP Test for Parallel Quantum Algorithms]() has been accepted to **ASPLOS '26** (the ACM International Conference on Architectural Support for Programming Languages and Operating Systems)!
\\
...
\\
This work is done in collaboration with Brown University, Yale University, QuEra Inc., and MIT.
